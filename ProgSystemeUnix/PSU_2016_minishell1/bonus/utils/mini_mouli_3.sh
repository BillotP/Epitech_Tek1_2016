...
## Last update Sun Jan 22 21:32:04 2017 John Doe
##
...
title
(echo 'setenv one_two three' ; echo 'env') | env -i ./mysh > logs/tmp1 2>&1
ret1=$?
...
title
(echo 'setenv one42two three' ; echo 'env') | env -i ./mysh > logs/tmp1 2>&1
ret1=$?
